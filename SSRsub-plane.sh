...
#subscriptions
SUB_URL_DIC=( \
      [FastCat]="http://www.fcjiasu.top/link/N0i1ef7WD0yCT3Al?mu=0" \
      [二号公寓]="http://vpn.didikan.xyz/link/jiGjjChGzw2Hqiud?mu=0" \
      [就是爱自由]="https://www.94ish.men/link/T92Fy0QDSuPtVG2A?mu=0" \
      [Bili]="https://bilibili.cafe/link/IpnFsRymR6mBBvyT?mu=0" \
      [jijiWorld]="https://jiji.world/link/upTLpFPXKjgrBvm4" \
      [喵帕斯]="https://npsboost.com/link/9bRDzClRTPcU9TKr?mu=1" \
      [魔梯云]="https://motiyun.co/modules/servers/UnlimitedSocks/subscribe.php?sid=687&token=iiljmycp" \
      [youheiss]="http://url.com/link/8MUHxZgVzw7pGDYC?mu=0" \
      [JustSSR]="https://www.justssr.com/link/wlwqyTHmd6alEOPl?mu=0" \
      )
